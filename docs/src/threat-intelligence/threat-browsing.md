...
- [TorLinks (onion link list)](http://torlinksge6enmcyyuxjpjkoouw4oorgdgeo7ftnq3zodj7g2zxi3kyd.onion/)

### 🕷️ Crawlers / Bots

- [TorBot](https://github.com/DedSecInside/TorBot) - CLI Tools to crawl on darkweb.
- [onionscan](https://github.com/s-rah/onionscan) - Investigated Tor.
- [pryingdeep](https://github.com/iudicium/pryingdeep) - OSINT gathering tool for the dark / clear web.
- [TorCrawl](https://github.com/MikeMeliz/TorCrawl.py) - Tool for anonymous web scraping via the Tor network.
