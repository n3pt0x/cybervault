...
- [TheHarvester](https://github.com/laramies/theHarvester) - Gather emails, subdomains, hosts, ports, and more.
- [Sn0int](https://github.com/kpcyrd/sn0int) - Semi-automatic OSINT framework & package manager.
- [Datasploit](https://github.com/DataSploit/datasploit) - OSINT automation (domains, IPs, emails, usernames).
- [Cyberbro](https://github.com/stanfrbd/Cyberbro) - Multi-Service Checks, Pivoting (Discover related domains), Graph, Reports making.
- [Maltego](https://www.maltego.com/categories/osint/) - Graph-based intelligence platform (free & commercial).
