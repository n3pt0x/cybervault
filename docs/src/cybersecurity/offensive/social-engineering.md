...
- [The Best Social Engineering Books](https://www.reddit.com/r/SocialEngineering/comments/kvr07b/the_best_social_engineering_books/)
- [Reference & Guide](https://s0cm0nkey.gitbook.io/s0cm0nkeys-security-reference-guide/red-offensive/social-engineering)
...
- [espoofer](https://github.com/chenjj/espoofer) - Bypass SPF, DKIM, DMARC authentication in email systems.
